...
PHOTOS = {
    "en": {
        ...
        6: dict(file="zahwa-diploma-university-of-malta.jpg",
                ...
                cap="The document behind Figure 5\u2019s third row: the University of Malta diploma conferring a Bachelor of Arts with honours, magna cum laude, on 13 November 2017 \u2014 issued in the family name El Kodwa, the Arafats\u2019 al-Qudwa. Document obtained by Times of Palestine."),
    ...
    "ar": {
        ...
        6: dict(file="zahwa-diploma-university-of-malta.jpg",
                ...
                cap="الوثيقة خلف السطر الثالث في الشكل ٥: شهادة جامعة مالطا بنيل البكالوريوس في الآداب بمرتبة الشرف مع الامتياز بتاريخ ١٣ تشرين الثاني ٢٠١٧ — صادرة باسم عائلة عرفات الحقيقي، «القدوة». وثيقة حصلت عليها تايمز أوف فلسطين."),
        7: dict(file="zahwa-gaza-child-malta.jpg",
