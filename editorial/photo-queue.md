...
| palestinian-minds-shikaki-2026 | rights-cleared portrait of Khalil Shikaki — PSR's own press material (pcpsr.org) or the Brandeis Crown Center faculty page; both are institutions that license headshots on request. Manifest entry required |
| palestinian-minds-* (weekly franchise) | rights-cleared portraits of each scholar — university press offices routinely license faculty headshots on request, and many publish them under open terms; ask per subject. Launch entry `palestinian-minds-abu-rabia-2026` leads on the franchise brand art until a portrait of Salim Abu-Rabia is cleared (University of Haifa press office). Manifest entry required |
| hani-almadhoun-airport-screening-2026 | rights-cleared portrait of Hani Almadhoun — UNRWA USA press material or the Gaza Soup Kitchen's own photographs, both reachable by asking the organisations directly; NPR/NBC/Salon frames are copyrighted. Manifest entry required; the boarding-pass SVG then moves in-body |
| nadia-bilbassy-memoir-2026 | rights-cleared portrait of Nadia Bilbassy at the White House briefing room, or the HarperCollins jacket image once the publisher issues press material (author photos travel with a press kit) — manifest entry required; the house jacket SVG then moves in-body |
| govmap-northern-gaza-imagery-2026-09-24 | rights-cleared aerial or drone photograph of the destruction in Beit Hanoun or Shujaiya — UNRWA, OCHA and UNOSAT publish imagery under open terms, and a manifest entry is required. The govmap frames themselves are Israeli state imagery of unclear licence and are described in the copy rather than reproduced; the schematic cover then moves in-body beside the resolution chart |
